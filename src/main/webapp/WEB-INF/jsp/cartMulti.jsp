...
<%@ include file="common/navigation.jspf" %>
	...
	<c:forEach items="${cartListMap}" var="map">
		<%-- alert("${map.key}"); --%>
		<div><h1 class="display-4">${map.key}'s Items</h1></div>
		<div class="card-deck">
				...
				<div  class="card" style="max-width: 18rem;margin-bottom:20px;">
				 ...
				 <div class="card-body">
								...
								<form:form method="post" commandName="product">
									...
									<form:hidden path="forusername" value="${product.forusername}"/>
		...
		<a role="button" href="/productsMulti" class="btn btn-info">Shop</a>
		<a id ="checkout" role="button" href="/invoiceMulti" class="btn btn-success">Checkout</a>
	</div>
